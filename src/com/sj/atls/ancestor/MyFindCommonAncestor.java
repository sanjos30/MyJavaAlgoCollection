...
public class MyFindCommonAncestor {
	...
	public static String findCommmonAncestor(String[] commitHashes, String[][] parentHashes, String commitHash1,
			String commitHash2) {
	...
	private static void addToCommitPath(Set<String> commitPathSet, int beginingIndex, String commitHash,
	...
	private static boolean[] markMatchingIndexes(String commitHash, String[] commitHashes, String[][] parentHashes) {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				"Common Ancestor is " + myFindCommonAncestor.findCommmonAncestor(commits, parents, commit1, commit2));
	}
