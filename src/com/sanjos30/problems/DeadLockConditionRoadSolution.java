 ...
 *
 */
public class DeadLockConditionRoadSolution {
	...
	private static class Intersection {
		...
		public void takeRoadB() {
			...
			// To fix problem, take a lock on Road A by track B so that no train
			// in A is passing.
			// THis also ensure that no train on Road A is passing
			synchronized (roadA) {
